...
例：
![](https://upload-images.jianshu.io/upload_images/15777037-5524c32916303211.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
可以看出Numpy比Python方法要快10到100倍，并且使用内存少。

### ndarray可以像操作标量一样操作整块数据
ndarray是Python中一个快速、灵活的大型数据集容器。数组允许使用类似于标量的操作语法在整块数据上进行数学计算。如下：
![](https://upload-images.jianshu.io/upload_images/15777037-fc048800f60c37df.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/15777037-ebf24d390749972d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

### 如何生成ndarray
1. 使用array函数:arrray函数接收任意的序列型对象（包括其他的数组），其中嵌套序列会自动转换成多维数组。
![](https://upload-images.jianshu.io/upload_images/15777037-d5338920772916ad.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
从上图也可以看出，ndarray会自动将不同类型的元素给转换为同一类型，并将数据类型存储在元数据dtype中。如果没特别指明的话，默认的数据类型是float64。
![](https://upload-images.jianshu.io/upload_images/15777037-35cd7713729e1b7d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
2. zeros函数：一次性创建全0数组
3. ones函数：一次性创建全1数组
4. empty函数：可以创建一个没有初始化数值的数组。该函数并不安全，有些时候它可能返回未初始化的垃圾数值。
![](https://upload-images.jianshu.io/upload_images/15777037-8763393220d688eb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
5. arange是Python内建函数range的数组版
![](https://upload-images.jianshu.io/upload_images/15777037-1efdf9846fe38d55.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
更多函数：
![](https://upload-images.jianshu.io/upload_images/15777037-17d4f57470ef2043.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/15777037-5fac819d85be9b8e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/15777037-8919d75d830023f4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
![](https://upload-images.jianshu.io/upload_images/15777037-d15232eec6baa5c4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

#### 使用astype方法改变数组的dtype
1. astype是重新创建一个数组（一个数据的备份），即使新的dtype和旧的dtype相同；如果浮点数转换成整数，则小数部分会被截取删除。如下：
![](https://upload-images.jianshu.io/upload_images/15777037-b5d36124c52be238.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
2. 可以将字符串数据类型转换为数值类型：如果字符串数组表示的全是数字，也可以用astype方法转换为数值形式：
![](https://upload-images.jianshu.io/upload_images/15777037-fef381115afc8acb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
3. 可以使用其他的数组类型作为值，进行转换
![](https://upload-images.jianshu.io/upload_images/15777037-57a4203b833adb4a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
4. 可以使用简洁的类型代码表示dtype
![](https://upload-images.jianshu.io/upload_images/15777037-67b5e198d32671c7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

### 数组之间的运算
数组可以使你不用编写循环即可对数据执行批量操作。Numpy用户称之为矢量化。**大小相同**的数组之间的任何运算都会应用到元素级：
![](https://upload-images.jianshu.io/upload_images/15777037-d4a1ce886e0a6067.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
